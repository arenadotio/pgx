...
let test_time_of_string _ =
  ...
  assert_equal ~printer expected (time_roundtrip "2016-03-15 19:55:18.123456-04");
  assert_equal ~printer expected (time_roundtrip "2016-03-15 19:55:18.123456-04:00")
